              ...
              <DialogContent>
                ...
                <div className="grid gap-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div><Label>Valor</Label><CurrencyInput valueInCents={form.amount_cents} onValueChange={(value) => setForm({ ...form, amount_cents: value ?? 0 })} /></div>
            ...
            {remaining > 0 && (
              <div className="grid gap-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label>Valor</Label>
                    <CurrencyInput valueInCents={amount ? Math.round(amount * 100) : undefined} onValueChange={(value) => setAmount((value ?? 0) / 100)} />
