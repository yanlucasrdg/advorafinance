...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Legion AI Legal OS — Sistema operacional jurídico com IA" },
      ...
      { name: "twitter:title", content: "Legion AI Legal OS — Sistema operacional jurídico com IA" },
